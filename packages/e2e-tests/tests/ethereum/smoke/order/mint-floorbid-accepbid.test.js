...
describe.each(suites())("$blockchain mint => floorBid => acceptBid", function (suite) {
    ...
    test(suite.description, function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var walletAddressSeller, walletAddressBuyer, address, collection, nft, requestCurrency, bidRequest, bidOrder;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
