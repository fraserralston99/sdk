...
exports.getActionHouseEscrowWithdrawInstructions = void 0;
...
function getActionHouseEscrowWithdrawInstructions(request) {
    return __awaiter(this, void 0, void 0, function () {
        var walletKeyPair, anchorProgram, auctionHouseObj, amountAdjusted, _a, _b, escrowPaymentAccount, escrowBump, isNative, ata, signers, instruction;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ata = (_c.sent())[0];
                    signers = [];
                    return [4 /*yield*/, anchorProgram.instruction.withdraw(escrowBump, amountAdjusted, {
                            accounts: {
...
exports.getActionHouseEscrowWithdrawInstructions = getActionHouseEscrowWithdrawInstructions;
