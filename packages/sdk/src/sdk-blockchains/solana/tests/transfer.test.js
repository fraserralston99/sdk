...
describe("Solana transfer", function () {
    var wallet = (0, test_wallets_1.getWallet)();
    var receiverWallet = (0, test_wallets_1.getWallet)(1);
    var sdk = (0, create_sdk_1.createSdk)(wallet);
    test("Should transfer nft", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                    ...
                    return [4 /*yield*/, (0, retry_1.retry)(10, 4000, function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        burn = _a.sent();
                                        return [2 /*return*/, burn.submit({
                                                to: (0, types_1.toUnionAddress)("SOLANA:" + receiverWallet.publicKey),
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, retry_1.retry)(10, 4000, function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.balances.getBalance((0, types_1.toUnionAddress)("SOLANA:" + receiverWallet.publicKey), (0, types_1.toCurrencyId)(itemId))];
                                    case 1:
                                        balance = _a.sent();
                                        if (parseFloat(balance.toString()) < 1) {
                                            throw new Error("Wrong balance value. Expected ".concat(1, ". Actual: ").concat(balance.toString()));
